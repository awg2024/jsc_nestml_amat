 ...
 *
 *  Generated from NESTML 8.3.0-rc3-post-dev at time: 2026-08-18 14:16:57.052135
**/
#ifndef AMAT_NEURON
#define AMAT_NEURON
...
**/
extern "C" inline int amat_neuron_dynamics_V_m_V_th_alpha_1_V_th_alpha_2_V_th_v_V_th_v_aux_refr_t( double, const double ode_state[], double f[], void* pnode );
/**
 * Function computing right-hand side of ODE for GSL solver.
 * @note Must be declared here so we can befriend it in class.
 * @note Must have C-linkage for passing to GSL. Internally, it is
...
**/
extern "C" inline int amat_neuron_dynamics_V_m_V_th_alpha_1_V_th_alpha_2_V_th_v_V_th_v_aux( double, const double ode_state[], double f[], void* pnode );
/**
 * Function computing right-hand side of ODE for GSL solver.
 * @note Must be declared here so we can befriend it in class.
 * @note Must have C-linkage for passing to GSL. Internally, it is
...
**/
extern "C" inline int amat_neuron_dynamics( double, const double ode_state[], double f[], void* pnode );
...
class amat_neuron : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
  amat_neuron(const amat_neuron &);

  /**
   * Destructor.
  **/
  ~amat_neuron() override;
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<amat_neuron>;
  friend class nest::UniversalDataLogger<amat_neuron>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(amat_neuron &);
    Buffers_(const Buffers_ &, amat_neuron &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<amat_neuron> logger_;
...
private:
  ...
  **/
  ...
  static nest::RecordablesMap<amat_neuron> recordablesMap_;
  friend int amat_neuron_dynamics_V_m_V_th_alpha_1_V_th_alpha_2_V_th_v_V_th_v_aux_refr_t( double, const double ode_state[], double f[], void* pnode );
  friend int amat_neuron_dynamics_V_m_V_th_alpha_1_V_th_alpha_2_V_th_v_V_th_v_aux( double, const double ode_state[], double f[], void* pnode );
  friend int amat_neuron_dynamics( double, const double ode_state[], double f[], void* pnode );

}; /* neuron amat_neuron */

inline nest_port_t amat_neuron::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t amat_neuron::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t amat_neuron::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t amat_neuron::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void amat_neuron::get_status(DictionaryDatum&__d) const
{
  // parameters

  def< double >(__d, nest::amat_neuron_names::_tau_m, get_tau_m());

  def< double >(__d, nest::amat_neuron_names::_C_m, get_C_m());

  def< double >(__d, nest::amat_neuron_names::_refr_T, get_refr_T());

  def< double >(__d, nest::amat_neuron_names::_E_L, get_E_L());

  def< double >(__d, nest::amat_neuron_names::_tau_syn_exc, get_tau_syn_exc());

  def< double >(__d, nest::amat_neuron_names::_tau_syn_inh, get_tau_syn_inh());

  def< double >(__d, nest::amat_neuron_names::_tau_1, get_tau_1());

  def< double >(__d, nest::amat_neuron_names::_tau_2, get_tau_2());

  def< double >(__d, nest::amat_neuron_names::_alpha_1, get_alpha_1());

  def< double >(__d, nest::amat_neuron_names::_alpha_2, get_alpha_2());

  def< double >(__d, nest::amat_neuron_names::_omega, get_omega());

  def< double >(__d, nest::amat_neuron_names::_tau_v, get_tau_v());

  def< double >(__d, nest::amat_neuron_names::_beta, get_beta());

  def< double >(__d, nest::amat_neuron_names::_I_e, get_I_e());

  // internals

  def< double >(__d, nest::amat_neuron_names::_unit_psc, get_unit_psc());

  def< double >(__d, nest::amat_neuron_names::___h, get___h());

  def< double >(__d, nest::amat_neuron_names::___P__V_th_alpha_1__V_th_alpha_1, get___P__V_th_alpha_1__V_th_alpha_1());

  def< double >(__d, nest::amat_neuron_names::___P__V_th_alpha_2__V_th_alpha_2, get___P__V_th_alpha_2__V_th_alpha_2());

  def< double >(__d, nest::amat_neuron_names::___P__V_m__V_m, get___P__V_m__V_m());

  def< double >(__d, nest::amat_neuron_names::___P__V_m__I_kernel_inh__X__inh_spikes, get___P__V_m__I_kernel_inh__X__inh_spikes());

  def< double >(__d, nest::amat_neuron_names::___P__V_m__I_kernel_exc__X__exc_spikes, get___P__V_m__I_kernel_exc__X__exc_spikes());

  def< double >(__d, nest::amat_neuron_names::___P__refr_t__refr_t, get___P__refr_t__refr_t());

  def< double >(__d, nest::amat_neuron_names::___P__I_kernel_inh__X__inh_spikes__I_kernel_inh__X__inh_spikes, get___P__I_kernel_inh__X__inh_spikes__I_kernel_inh__X__inh_spikes());

  def< double >(__d, nest::amat_neuron_names::___P__I_kernel_exc__X__exc_spikes__I_kernel_exc__X__exc_spikes, get___P__I_kernel_exc__X__exc_spikes__I_kernel_exc__X__exc_spikes());

  // initial values for state variables in ODE or kernel

  def< double >(__d, nest::amat_neuron_names::_V_th_alpha_1, get_V_th_alpha_1());

  def< double >(__d, nest::amat_neuron_names::_V_th_alpha_2, get_V_th_alpha_2());

  def< double >(__d, nest::amat_neuron_names::_V_th_v, get_V_th_v());

  def< double >(__d, nest::amat_neuron_names::_V_th_v_aux, get_V_th_v_aux());

  def< double >(__d, nest::amat_neuron_names::_V_m, get_V_m());

  def< double >(__d, nest::amat_neuron_names::_refr_t, get_refr_t());

  def< double >(__d, nest::amat_neuron_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());

  def< double >(__d, nest::amat_neuron_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
...
def< double >(__d, nest::amat_neuron_names::gsl_abs_error_tol, P_.__gsl_abs_error_tol);
  if ( P_.__gsl_abs_error_tol <= 0. ){
    throw nest::BadProperty( "The gsl_abs_error_tol must be strictly positive." );
  }
  
def< double >(__d, nest::amat_neuron_names::gsl_rel_error_tol, P_.__gsl_rel_error_tol);
  if ( P_.__gsl_rel_error_tol < 0. ){
    throw nest::BadProperty( "The gsl_rel_error_tol must be zero or positive." );
  }
}

inline void amat_neuron::set_status(const DictionaryDatum&__d)
{
  // parameters
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_tau_m, tmp_tau_m, this);
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_C_m, tmp_C_m, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_refr_T, tmp_refr_T, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_E_L, tmp_E_L, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_1 = get_tau_1();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_tau_1, tmp_tau_1, this);
  double tmp_tau_2 = get_tau_2();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_tau_2, tmp_tau_2, this);
  double tmp_alpha_1 = get_alpha_1();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_alpha_1, tmp_alpha_1, this);
  double tmp_alpha_2 = get_alpha_2();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_alpha_2, tmp_alpha_2, this);
  double tmp_omega = get_omega();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_omega, tmp_omega, this);
  double tmp_tau_v = get_tau_v();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_tau_v, tmp_tau_v, this);
  double tmp_beta = get_beta();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_beta, tmp_beta, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_th_alpha_1 = get_V_th_alpha_1();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_V_th_alpha_1, tmp_V_th_alpha_1, this);
  double tmp_V_th_alpha_2 = get_V_th_alpha_2();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_V_th_alpha_2, tmp_V_th_alpha_2, this);
  double tmp_V_th_v = get_V_th_v();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_V_th_v, tmp_V_th_v, this);
  double tmp_V_th_v_aux = get_V_th_v_aux();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_V_th_v_aux, tmp_V_th_v_aux, this);
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_V_m, tmp_V_m, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_refr_t, tmp_refr_t, this);
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes, this);
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  nest::updateValueParam<double>(__d, nest::amat_neuron_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes, this);
  ...
  updateValue<double>(__d, nest::amat_neuron_names::gsl_abs_error_tol, P_.__gsl_abs_error_tol);
  if ( P_.__gsl_abs_error_tol <= 0. )
  {
    throw nest::BadProperty( "The gsl_abs_error_tol must be strictly positive." );
  }
  updateValue<double>(__d, nest::amat_neuron_names::gsl_rel_error_tol, P_.__gsl_rel_error_tol);
  if ( P_.__gsl_rel_error_tol < 0. )
  {
    throw nest::BadProperty( "The gsl_rel_error_tol must be zero or positive." );
  }
