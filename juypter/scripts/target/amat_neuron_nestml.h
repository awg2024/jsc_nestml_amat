 ...
 *
 *  Generated from NESTML 8.3.0 at time: 2026-08-01 13:53:46.816641
**/
...
refr_T [ms]  Note: NEST counts this down via discrete time-steps (rounding to zero), while NESTML uses a continuous ODE process, 
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  {    
    ...
    double C_m;
    //!  Note: NEST counts this down via discrete time-steps (rounding to zero), while NESTML uses a continuous ODE process, 
    double refr_T;
    //!  Resting potential
    double E_L;
