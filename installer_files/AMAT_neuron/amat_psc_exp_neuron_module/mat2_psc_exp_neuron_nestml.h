 ...
 *
 *  Generated from NESTML 8.2.0 at time: 2026-07-20 14:56:52.790862
**/
#ifndef MAT2_PSC_EXP_NEURON_NESTML
#define MAT2_PSC_EXP_NEURON_NESTML
...
namespace nest
{
namespace mat2_psc_exp_neuron_nestml_names
{
...
**/
extern "C" inline int mat2_psc_exp_neuron_nestml_dynamics_refr_t( double, const double ode_state[], double f[], void* pnode );
/**
 * Function computing right-hand side of ODE for GSL solver.
 * @note Must be declared here so we can befriend it in class.
 * @note Must have C-linkage for passing to GSL. Internally, it is
 ...
 * @param void* Pointer to model neuron instance.
 *
 * Integrate the variables: V_m_V_th_v_V_th_v_aux
**/
extern "C" inline int mat2_psc_exp_neuron_nestml_dynamics_V_m_V_th_v_V_th_v_aux( double, const double ode_state[], double f[], void* pnode );
/**
 * Function computing right-hand side of ODE for GSL solver.
 * @note Must be declared here so we can befriend it in class.
 * @note Must have C-linkage for passing to GSL. Internally, it is
...
**/
extern "C" inline int mat2_psc_exp_neuron_nestml_dynamics( double, const double ode_state[], double f[], void* pnode );
...
/* BeginDocumentation
  Name: mat2_psc_exp_neuron_nestml
...
tau_m [ms]  Membrane time constant (Yamauchi et al. explicitly states to use 10 ms)
...
tau_V [ms]  Timescale of the voltage-dependency kernel K(s)=s*exp(-s/tau_V) [4]
beta [1 / ms]  Strength/sign of voltage dependency. beta=0 recovers mat2_psc_exp
I_e [pA] constant external input current


  Dynamic state variables:
V_th_alpha_1 [mV]  Two-timescale adaptive threshold  (spike-history, short)
V_th_alpha_2 [mV]  Two-timescale adaptive threshold  (spike-history, long)
V_th_v [mV]  Voltage-dependent threshold term theta_V (driven by dV/dt)
V_th_v_aux [mV / ms]  Auxiliary variable w = dtheta_V/dt + theta_V/tau_V,
V_m [mV]  Absolute membrane potential
...
void register_mat2_psc_exp_neuron_nestml( const std::string& name );

class mat2_psc_exp_neuron_nestml : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
  mat2_psc_exp_neuron_nestml(const mat2_psc_exp_neuron_nestml &);

  /**
   * Destructor.
  **/
  ~mat2_psc_exp_neuron_nestml() override;
  ...
  **/
  ...
  inline double get_P11th() const
  {
    return V_.P11th;
  }

  inline void set_P11th(const double __v)
  {
    V_.P11th = __v;
  }
  inline double get_P22th() const
  {
    return V_.P22th;
  }

  inline void set_P22th(const double __v)
  {
    V_.P22th = __v;
  }
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<mat2_psc_exp_neuron_nestml>;
  friend class nest::UniversalDataLogger<mat2_psc_exp_neuron_nestml>;
...
//!  Two-timescale adaptive threshold  (spike-history, short)
double V_th_alpha_1;
//!  Two-timescale adaptive threshold  (spike-history, long)
double V_th_alpha_2;
  ...
  **/
  struct Buffers_
  {
    Buffers_(mat2_psc_exp_neuron_nestml &);
    Buffers_(const Buffers_ &, mat2_psc_exp_neuron_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<mat2_psc_exp_neuron_nestml> logger_;
  ...
  **/
  ...
  static nest::RecordablesMap<mat2_psc_exp_neuron_nestml> recordablesMap_;
  friend int mat2_psc_exp_neuron_nestml_dynamics_refr_t( double, const double ode_state[], double f[], void* pnode );
  friend int mat2_psc_exp_neuron_nestml_dynamics_V_m_V_th_v_V_th_v_aux( double, const double ode_state[], double f[], void* pnode );
  friend int mat2_psc_exp_neuron_nestml_dynamics( double, const double ode_state[], double f[], void* pnode );

}; /* neuron mat2_psc_exp_neuron_nestml */

inline nest_port_t mat2_psc_exp_neuron_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t mat2_psc_exp_neuron_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t mat2_psc_exp_neuron_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t mat2_psc_exp_neuron_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void mat2_psc_exp_neuron_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_m, get_tau_m());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_C_m, get_C_m());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_refr_T, get_refr_T());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_E_L, get_E_L());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_syn_exc, get_tau_syn_exc());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_syn_inh, get_tau_syn_inh());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_1, get_tau_1());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_2, get_tau_2());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_alpha_1, get_alpha_1());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_alpha_2, get_alpha_2());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_omega, get_omega());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_V, get_tau_V());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_beta, get_beta());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_alpha_1, get_V_th_alpha_1());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_alpha_2, get_V_th_alpha_2());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_v, get_V_th_v());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_v_aux, get_V_th_v_aux());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_m, get_V_m());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_refr_t, get_refr_t());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());

  ArchivingNode::get_status( __d );

  (*__d)[nest::names::recordables] = recordablesMap_.get_list();
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::gsl_abs_error_tol, P_.__gsl_abs_error_tol);
  if ( P_.__gsl_abs_error_tol <= 0. ){
    throw nest::BadProperty( "The gsl_abs_error_tol must be strictly positive." );
  }
  def< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::gsl_rel_error_tol, P_.__gsl_rel_error_tol);
  if ( P_.__gsl_rel_error_tol < 0. ){
    throw nest::BadProperty( "The gsl_rel_error_tol must be zero or positive." );
  }
}

inline void mat2_psc_exp_neuron_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_C_m, tmp_C_m, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_refr_T, tmp_refr_T, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_E_L, tmp_E_L, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_1 = get_tau_1();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_1, tmp_tau_1, this);
  double tmp_tau_2 = get_tau_2();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_2, tmp_tau_2, this);
  double tmp_alpha_1 = get_alpha_1();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_alpha_1, tmp_alpha_1, this);
  double tmp_alpha_2 = get_alpha_2();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_alpha_2, tmp_alpha_2, this);
  double tmp_omega = get_omega();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_omega, tmp_omega, this);
  double tmp_tau_V = get_tau_V();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_tau_V, tmp_tau_V, this);
  double tmp_beta = get_beta();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_beta, tmp_beta, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_th_alpha_1 = get_V_th_alpha_1();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_alpha_1, tmp_V_th_alpha_1, this);
  double tmp_V_th_alpha_2 = get_V_th_alpha_2();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_alpha_2, tmp_V_th_alpha_2, this);
  double tmp_V_th_v = get_V_th_v();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_v, tmp_V_th_v, this);
  double tmp_V_th_v_aux = get_V_th_v_aux();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_th_v_aux, tmp_V_th_v_aux, this);
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_V_m, tmp_V_m, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_refr_t, tmp_refr_t, this);
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes, this);
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_nestml_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes, this);
  ...
  updateValue< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::gsl_abs_error_tol, P_.__gsl_abs_error_tol);
  if ( P_.__gsl_abs_error_tol <= 0. )
  {
    throw nest::BadProperty( "The gsl_abs_error_tol must be strictly positive." );
  }
  updateValue< double >(__d, nest::mat2_psc_exp_neuron_nestml_names::gsl_rel_error_tol, P_.__gsl_rel_error_tol);
  if ( P_.__gsl_rel_error_tol < 0. )
  {
    throw nest::BadProperty( "The gsl_rel_error_tol must be zero or positive." );
  }
...
#endif /* #ifndef MAT2_PSC_EXP_NEURON_NESTML */
