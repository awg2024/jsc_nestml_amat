...
/*
 *  mat2_psc_exp_neuron_mat_nestml.cpp
 *
...
#include "mat2_psc_exp_neuron_mat_nestml.h"

// uncomment the next line to enable printing of detailed debug information
// #define DEBUG
void
register_mat2_psc_exp_neuron_mat_nestml( const std::string& name )
{
  nest::register_node_model< mat2_psc_exp_neuron_mat_nestml >( name );
}

// ---------------------------------------------------------------------------
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<mat2_psc_exp_neuron_mat_nestml> mat2_psc_exp_neuron_mat_nestml::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<mat2_psc_exp_neuron_mat_nestml>::create()
  {
    // add state variables to recordables map
   insert_(mat2_psc_exp_neuron_mat_nestml_names::_V_th_alpha_1, &mat2_psc_exp_neuron_mat_nestml::get_V_th_alpha_1);
   insert_(mat2_psc_exp_neuron_mat_nestml_names::_V_th_alpha_2, &mat2_psc_exp_neuron_mat_nestml::get_V_th_alpha_2);
   insert_(mat2_psc_exp_neuron_mat_nestml_names::_V_m, &mat2_psc_exp_neuron_mat_nestml::get_V_m);
   insert_(mat2_psc_exp_neuron_mat_nestml_names::_refr_t, &mat2_psc_exp_neuron_mat_nestml::get_refr_t);
   insert_(mat2_psc_exp_neuron_mat_nestml_names::_I_kernel_exc__X__exc_spikes, &mat2_psc_exp_neuron_mat_nestml::get_I_kernel_exc__X__exc_spikes);
   insert_(mat2_psc_exp_neuron_mat_nestml_names::_I_kernel_inh__X__inh_spikes, &mat2_psc_exp_neuron_mat_nestml::get_I_kernel_inh__X__inh_spikes);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > mat2_psc_exp_neuron_mat_nestml::rport_to_nestml_buffer_idx =
{
  
  { mat2_psc_exp_neuron_mat_nestml::EXC_SPIKES, mat2_psc_exp_neuron_mat_nestml::INH_SPIKES },
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of mat2_psc_exp_neuron_mat_nestml's constructor.
// ---------------------------------------------------------------------------

mat2_psc_exp_neuron_mat_nestml::Parameters_::Parameters_()
{
}

mat2_psc_exp_neuron_mat_nestml::State_::State_()
{
}
...
mat2_psc_exp_neuron_mat_nestml::Buffers_::Buffers_(mat2_psc_exp_neuron_mat_nestml &n):
  logger_(n)
...
mat2_psc_exp_neuron_mat_nestml::Buffers_::Buffers_(const Buffers_ &, mat2_psc_exp_neuron_mat_nestml &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
mat2_psc_exp_neuron_mat_nestml::mat2_psc_exp_neuron_mat_nestml():ArchivingNode(), P_(), S_(), B_(*this)
{
...
mat2_psc_exp_neuron_mat_nestml::mat2_psc_exp_neuron_mat_nestml(const mat2_psc_exp_neuron_mat_nestml& __n):
...
mat2_psc_exp_neuron_mat_nestml::~mat2_psc_exp_neuron_mat_nestml()
{
}
...
// ---------------------------------------------------------------------------
void mat2_psc_exp_neuron_mat_nestml::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
...
void mat2_psc_exp_neuron_mat_nestml::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] mat2_psc_exp_neuron_mat_nestml::init_state_internal_()" << std::endl;
#endif
...
void mat2_psc_exp_neuron_mat_nestml::init_buffers_()
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] mat2_psc_exp_neuron_mat_nestml::init_buffers_()" << std::endl;
#endif
  // spike input buffers
...
void mat2_psc_exp_neuron_mat_nestml::recompute_internal_variables(bool exclude_timestep)
{
  const double __timestep = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the timestep() function
...
void mat2_psc_exp_neuron_mat_nestml::pre_run_hook()
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] mat2_psc_exp_neuron_mat_nestml::pre_run_hook()" << std::endl;
#endif
...
void mat2_psc_exp_neuron_mat_nestml::update(nest::Time const & origin, const long from, const long to)
{
  const double __timestep = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the timestep() function
...
#ifdef DEBUG
    std::cout << "[neuron " << this << "] mat2_psc_exp_neuron_mat_nestml::update: handling post spike at t = " << get_t() << std::endl;
#endif
    /**
...
void mat2_psc_exp_neuron_mat_nestml::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void mat2_psc_exp_neuron_mat_nestml::handle(nest::SpikeEvent &e)
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] mat2_psc_exp_neuron_mat_nestml::handle(SpikeEvent)" << std::endl;
#endif
  ...
  else
  {
    ...
    if ( nestml_buffer_idx == mat2_psc_exp_neuron_mat_nestml::PORT_NOT_AVAILABLE )
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void mat2_psc_exp_neuron_mat_nestml::handle(nest::CurrentEvent& e)
{
#ifdef DEBUG
  std::cout << "[neuron " << this << "] mat2_psc_exp_neuron_mat_nestml::handle(CurrentEvent)" << std::endl;
#endif
  assert(e.get_delay_steps() > 0);
