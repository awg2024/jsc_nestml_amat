...
/**
 *  mat2_psc_exp_neuron_mat_nestml.h
 *
 ...
 *
 *  Generated from NESTML 8.2.0 at time: 2026-07-15 12:24:13.418567
**/
#ifndef MAT2_PSC_EXP_NEURON_MAT_NESTML
#define MAT2_PSC_EXP_NEURON_MAT_NESTML
...
namespace nest
{
namespace mat2_psc_exp_neuron_mat_nestml_names
{
...
/* BeginDocumentation
  Name: mat2_psc_exp_neuron_mat_nestml
...
void register_mat2_psc_exp_neuron_mat_nestml( const std::string& name );

class mat2_psc_exp_neuron_mat_nestml : public nest::ArchivingNode
{
public:
  /**
   * The constructor is only used to create the model prototype in the model manager.
  **/
  mat2_psc_exp_neuron_mat_nestml();
  ...
  **/
  mat2_psc_exp_neuron_mat_nestml(const mat2_psc_exp_neuron_mat_nestml &);

  /**
   * Destructor.
  **/
  ~mat2_psc_exp_neuron_mat_nestml() override;
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<mat2_psc_exp_neuron_mat_nestml>;
  friend class nest::UniversalDataLogger<mat2_psc_exp_neuron_mat_nestml>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(mat2_psc_exp_neuron_mat_nestml &);
    Buffers_(const Buffers_ &, mat2_psc_exp_neuron_mat_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<mat2_psc_exp_neuron_mat_nestml> logger_;
  ...
  **/
  ...
  static nest::RecordablesMap<mat2_psc_exp_neuron_mat_nestml> recordablesMap_;

}; /* neuron mat2_psc_exp_neuron_mat_nestml */

inline nest_port_t mat2_psc_exp_neuron_mat_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t mat2_psc_exp_neuron_mat_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t mat2_psc_exp_neuron_mat_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t mat2_psc_exp_neuron_mat_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void mat2_psc_exp_neuron_mat_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_m, get_tau_m());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_C_m, get_C_m());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_refr_T, get_refr_T());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_E_L, get_E_L());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_syn_exc, get_tau_syn_exc());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_syn_inh, get_tau_syn_inh());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_1, get_tau_1());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_2, get_tau_2());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_alpha_1, get_alpha_1());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_alpha_2, get_alpha_2());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_omega, get_omega());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_V_th_alpha_1, get_V_th_alpha_1());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_V_th_alpha_2, get_V_th_alpha_2());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_V_m, get_V_m());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_refr_t, get_refr_t());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
  def< double >(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());
...
inline void mat2_psc_exp_neuron_mat_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_C_m, tmp_C_m, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_refr_T, tmp_refr_T, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_E_L, tmp_E_L, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_1 = get_tau_1();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_1, tmp_tau_1, this);
  double tmp_tau_2 = get_tau_2();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_tau_2, tmp_tau_2, this);
  double tmp_alpha_1 = get_alpha_1();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_alpha_1, tmp_alpha_1, this);
  double tmp_alpha_2 = get_alpha_2();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_alpha_2, tmp_alpha_2, this);
  double tmp_omega = get_omega();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_omega, tmp_omega, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_I_e, tmp_I_e, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_th_alpha_1 = get_V_th_alpha_1();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_V_th_alpha_1, tmp_V_th_alpha_1, this);
  double tmp_V_th_alpha_2 = get_V_th_alpha_2();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_V_th_alpha_2, tmp_V_th_alpha_2, this);
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_V_m, tmp_V_m, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_refr_t, tmp_refr_t, this);
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes, this);
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::mat2_psc_exp_neuron_mat_nestml_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes, this);
...
#endif /* #ifndef MAT2_PSC_EXP_NEURON_MAT_NESTML */
